...
export class ToolbarComponent implements AfterViewInit {
  ...
  isCurrentLanguage(lang: Language) {
    return this.settingsService.settings.language === lang;
  }
